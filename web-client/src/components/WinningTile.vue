...
<template>
    <div class="rounded-lg w-full h-full shadow bg-tile_red" :class="'col-start-' + (props.tile.x + 1) + ' col-span-' + props.tile.width + ' row-start-' + (props.tile.y+1) + ' row-span-' + props.tile.height">
